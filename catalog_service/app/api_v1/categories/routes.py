...
@router.post(
    ...
    dependencies=[Depends(permission_required('category_create'))],
)
...
@router.get(
    ...
    dependencies=[Depends(permission_required('categories_read'))],
)
...
@router.put(
    '/{category_id}',
    response_model=CategorySchema,
    dependencies=[Depends(permission_required('category_update'))],
)
...
@router.delete(
    ...
    dependencies=[
        Depends(permission_required('category_delete')),
        Depends(services.delete_category),
    ],
)
